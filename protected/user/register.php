...
<form method="post">
	...
	<div class="form-row">
		<div class="form-group col-md-6">
			<label for="registerIGName">Felhasználónév</label>
			<input type="text" class="form-control" id="registerIGName" name="ingame_name" value="<?=isset($postData) ? $postData['igname'] : "";?>">
		</div>
	</div>
	...
	<button type="submit" class="btn btn-primary" name="register">Regisztrálok!</button>
</form>